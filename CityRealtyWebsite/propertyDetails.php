						...
						<div class="column col3">
							...
							<div class="row">
								<div class="small-12 columns" >
									<section id="map">
										<h4 class="fieldGroup"><i class="fa fa-map-marker fieldGroup"></i> Χάρτης Τοποθεσίας <small class="hide" itemscope itemtype="http://schema.org/GeoCoordinates"><span class="latitude" itemprop="latitude"><?php echo $row['Latitude']; ?></span>, <span class="longitude" itemprop="longitude"><?php echo $row['Longitude']; ?></span></small></h4>
										<script>
											function initialize() {
