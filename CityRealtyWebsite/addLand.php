								...
								<div id="RealEstateTab" class="section">
									...
									<div id="gi">
										<div class="col-md-6"><!--1i stili-->
											...
											<div>
												<label>Επιπλέον Χαρακτηριστικά</label><br>
												<?php $sql="SELECT * FROM LDetailsChoices";
												...
												while($row=mysqli_fetch_assoc($result)) {
													if ($i<4) {
														...
														if ($i==1)
															echo "<br>";
														echo"<input name='LD".$row['DetailNo']."' type='checkbox' value='".$row['DetailNo']."'> ".$row['Description']."</div>";
													}
													else 
														echo "<div class='col-md-6 checkbox'><input name='LD".$row['DetailNo']."' type='checkbox' value='".$row['DetailNo']."'> ".$row['Description']."</div>";
													$i++;
												} ?>
											</div>
										</div><!--end of 1i stili-->
										...
										<div class="col-md-6"><!--2i stili-->
											...
											<div>
												<label>Χρήση Γης</label><br>
												<?php $sql="SELECT * FROM LUseChoices";
												$result = mysqli_query($conn, $sql);
												$i=0;
												while($row=mysqli_fetch_assoc($result)) {
													if ($i<2) {
														...
														if ($i==1) 
															echo "<br>";
														echo"<input name='LU".$row['UseNo']."' type='checkbox' value='".$row['UseNo']."'> ".$row['Description']."</div>";
													}
													else 
														echo "<div class='col-md-6 checkbox'><input name='LU".$row['UseNo']."' type='checkbox' value='".$row['UseNo']."'> ".$row['Description']."</div>";
													$i++;
												} ?>
											</div>
										</div><!--end of 2i stili-->
