		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="row" id="somewhere">
					...
					$sql2 =  "SELECT RealEstateNo, Price, Currency, ShortDescription FROM RealEstate WHERE Category='$Type' AND ACity='$Location' AND Price=$Price";
						...
						if ($j<10) {
							...
							<div class='thumbnail'>
								<a href='propertyDetails.html'><img class='img-hover img-related'
									align='left' src='img/properties/3.jpg' width='380px' height='200px' alt='image not available' style='margin-right:30px'></a>
									<div class='caption'>
										<h3 class='pull-right'>".$row['Price']."</h3>
										<h3><a href='propertyDetails.html' style='color: #171820'>".$row['RealEstateNo']."</a></h3>
										<p>
											<br>".$row['ShortDescription']."<br>
										</p>
									</div>
									<div class='ratings'>
										<p class='pull-right' style='font-size:24px' style='color: #008c99'>
											For Sale
											<h3 style='color: #c03e62'> 1 <i class='fa fa-bed' style='font-size:24px'></i> 2 <i class='fa fa-bath' style='font-size:24px'></i></h3>
										</p>
									</div>
								</div>
							</div>";
					...
					<div class="row text-center">
						<div class="col-lg-12">
							<ul class="pagination">
								<li>
									<button type="submit" name="firstpage" value="1" style="color: #008c99" onclick="showtemplate(this.value)">&laquo;</button>
								</li>
								<li class="active">
									<button type="submit" name="currentpage" value=<?php echo "'$currentpage'"?> style="color: #008c99" onclick="showtemplate(this.value)"><?php echo "$currentpage" ?></button>
								</li>
								<li>
									<button type="submit" name="lastpage" value=<?php echo "'$pages'" ?> style="color: #008c99" onclick="showtemplate(this.value)">&raquo;</button>
								</li>
							</ul>
						</div>
					</div>
