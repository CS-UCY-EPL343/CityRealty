      ...
      <div id="content">
        <div id="mainwrap">
          <ul id="menu">
            <div>
              <li>
                <a class="tabs" href="#divtab1" title="Tab1">ΓΕΝΙΚΕΣ<br>ΠΛΗΡΟΦΟΡΙΕΣ</a>
              </li>
            </div>
            <div>
              <li>
                <a class="tabs" href="#tabs" title="Tab2">ΚΟΙΝΑ<br>ΧΑΡΑΚΤΗΡΙΣΤΙΚΑ</a>
              </li>
            </div>
            <div>
              <li>
        ...
        <div id="divtab1" class="section">
          <div class="column col3">
            ...
            <ul id="menu2">
              <li style="color: #008c99">Βασικές Πληροφορίες Ακινήτου
                <table>
                  <tr>
              ...
              <li style="color: #008c99">Αριθμητικές Πληροφορίες
                <table>
                  <tr>
            ...
            <ul id="menu2">
              <li style="color: #008c99">Γενικές πληροφορίες σχετικά με το συγκεκριμένο ακίνητο
                <table>
                  <tr>
              ...
              <li style="color: #008c99">
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <th><label class="value" id="View"><?php while($row3=mysqli_fetch_assoc($result3)) { $sql4 =  "SELECT Description FROM REViewChoices WHERE ViewNo=".$row3['ViewNo']; $result4 = mysqli_query($conn, $sql4); echo $row['Description']." "; } ?></label></th>
                  </tr>
                  <tr>
                    <th class="field">Γωνιακό</th>
                    <th><label class="value" id="Corner"><?php if ($row['Corner']==1) echo "Ναι"; else echo "Όχι"; ?></label></th>
                  </tr>
                </table>
              </li>
            </ul>
              ...
              <li style="color: #008c99">
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <th><label class="value" id="RegistartionTitle"><?php if ($row['RegistrationPurpose']==1) echo "Ναι"; else echo "Όχι"; ?></label></th>
                  </tr>
                  <tr>
                    <th class="field">Αντιπαροχή - ανταλλαγή</th>
                    <th><label class="value" id="ConsiderationExchange"><?php if ($row['ConsiderationExchange']==1) echo "Ναι"; else echo "Όχι"; ?></label></th>
                  </tr>
                </table>
              </li>
            </ul>
