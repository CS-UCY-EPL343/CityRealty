				...
				<div class="container-fluid">
					...
					<div class="row">
							...
							<div id="content">
								...
								<div id="epxwros"><!--start of epaggelmatikos xwros-->
										<div class="col-md-6"><!--1i stili-->
											...
											<div class="col-md-6">
												<br><label>Αριθμός Υπογείων</label>
												<span runat="server" ID="required" style="color:Red;" visible="false"> *</span>
