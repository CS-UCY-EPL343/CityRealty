	...
	<nav class="navbar navbar-custom navbar-fixed-top " role="navigation">
		...
		<div class="container-fluid" >
			...
			<ul class="nav navbar-nav ">
				...
				<li>
					<a class="page-scroll " href="#" style="color: #FFCC00"><img width="50px" height="50px" src="img/menu/sell22.png">Sell</span></a>
		...
		<div class="container">
			...
			<div class="row text-center">
				...
				<div class="col-lg-10 col-lg-offset-1">
					<h1 style="color: #c03e62;text-shadow: 1px 1px 1px #000000;">Θέλω κι εγώ το ακίνητο μου στην ιστοσελίδα σας!</h1>
					<hr class="small">
					<div class="row">
						<h4 style="color:black">Αν έχεις και εσύ κάποιο ακίνητο που θέλεις να πουλήσεις ή να ενοικιάσεις τότε μπορείς κι εσύ να γίνεις
							μέλος της εταιρείας μας και να βάλεις τα ακίνητα σου στην ιστοσελίδα μας!<br> 
							Συμπλήρωσε τα στοιχεία σου στην πιο κάτω φόρμα και θα επικοινωνήσουμε εμείς μαζί σου.</h4>
							
							<div class="row">
							<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
								<form class="colorText" role="form" action="signup2_inc.php" method="POST">
									<div class="row">
										<h5><u>Όνομα Μεσίτη</u>
										<span runat="server" ID="required" style="color:Red;" visible="false"> *</span></h5>
