		...
		<div class="row">
			...
			<div class="col-md-3" style = "background-color:#939393;">
				...
				<div class="list-group" style="color: #008c99">
					...
					<div class="thumbnailPopular">
						<a href="propertyDetails.php"><img class="img-responsive img-hover img-related" src="img/properties/4.jpg" alt="image not available"></a>
						<div class="caption">
							<h4 class="pull-right">$600</h4>
			...
			<div class="col-md-8">
				...
				<div class="row" id="somewhere">
					...
					if(!isset($_SESSION['sql3'])) {
						$sql2 = "SELECT RealEstateNo, ARegionCode, ACity, AvailableFrom, Price, Category, RegistrationPurpose, REState FROM RealEstate WHERE RegistrationPurpose='Ενοικίαση'";
					...
					while($row=mysqli_fetch_assoc($result2)) {
						...
						<li> <a style='color: #008c99' href='rent.php?page=1'>&laquo;</a></li>";  

						for ($i=1; $i<=$total_pages; $i++) { 
							if ($page==$i) {
								echo "<li class='active'><a style='color: #008c99' href='rent.php?page=".$i."'>".$i."</a></li>";
							} else {
								echo "<li><a style='color: #008c99' href='rent.php?page=".$i."'>".$i."</a></li>"; 
							}
						} 
						echo "<li><a style='color: #008c99' href='rent.php?page=$total_pages'>&raquo;</a></li></ul></div></div>";  
